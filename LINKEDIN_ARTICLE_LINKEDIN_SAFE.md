...
Rationale: Low cost, fast (<500ms), highly deterministic at low temperature  

---

**Math Agent**  
Model: Claude Sonnet 4.6  
Purpose: Step-by-step mathematical reasoning  
Rationale: Strong structured reasoning capabilities and reliable explanation quality  

---

**History Agent**  
Model: gpt-5.2  
Purpose: Factual narrative and historical explanation  
Rationale: Large context window and broad factual knowledge  

---

**English Agent**  
Model: gpt-realtime  
Purpose: Native speech-to-speech conversation  
Rationale: ~230ms time-to-first-byte and avoids STT→LLM→TTS latency chain  

---

**Guardrail Moderation**  
Model: omni-moderation-latest  
Purpose: Content safety detection  
Rationale: Extremely fast (~5ms), low cost, and highly reliable classification  

---

**Guardrail Rewrite Agent**  
Model: Claude Haiku 4.5  
Purpose: Age-appropriate safety rewrite  
Rationale: Fast, cost-effective, and controllable educational tone enforcement  
...
• agent.activated — tracks which agent was activated and when  
• routing.decision — records routing decisions and latency  
• tts.sentence — measures sentence generation and guardrail timing  
• guardrail.check — records moderation checks and classification results  
• guardrail.rewrite — tracks rewrite latency and transformations  
• teacher.escalation — records escalation events and intervention triggers  
